package chessbadger.game.view;

import chessbadger.*;
import chessbadger.game.*;
import chessbadger.move.*;
import chessbadger.position.*;
...
public class HTMLGameBrowser implements GameListener
{
    ...
    public synchronized void produceHTML(OutputStream outStream, Game game, boolean contentOnly)
    {
        ...
        if (!contentOnly) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<meta name=\"generator\" content=\"Chessbadger\" />");
...
//    {
//        try {
//            chessbadger.pgn.PGNReader pgn = new chessbadger.pgn.PGNReader(args[0]);
