...
public final class Position extends AbstractMovablePosition
{
...
//    }
    ...
    private static final int getFirstSqi(long bb)
    {
        ...
        //        } else {
        int sqi=0;
        if ((bb & 0xFFFFFFFFL) == 0L) {bb >>>= 32; sqi += 32;}  // is this good for all VMs?
...
//                if (getPiece(from) == Chess.PAWN) { //  necessary?
